...
public class PinnedSectionListView extends ListView {
    ...
    void createPinnedShadow(int position) {
        ...
        View pinnedView = adapter.getView(position, pinnedShadow.view, PinnedSectionListView.this);
        if (adapter instanceof PinAdapterBinder) {
            ((PinAdapterBinder) getAdapter()).bindPinnedView(pinnedView);
        }
