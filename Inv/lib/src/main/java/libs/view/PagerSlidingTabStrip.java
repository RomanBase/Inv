...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private boolean dotIndicator = false;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        dotIndicator = a.getBoolean(R.styleable.PagerSlidingTabStrip_pstsDotIndicator, dotIndicator);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (dotIndicator) {
            ...
            float offset = (height - indicatorHeight) * 0.5f;
            int c = tabsContainer.getChildCount();
            float r = underlineHeight * 0.5f;
            float y = v.getY() + v.getHeight() * 0.5f;
            float w = (float) v.getWidth() * 0.5f;
            dividerPaint.setColor(underlineColor);
            for (int i = 0; i < c; i++) {
                v = tabsContainer.getChildAt(i);
                canvas.drawCircle(v.getX() + w, y, r, dividerPaint);
            }

            r = indicatorHeight * 0.5f;
            canvas.drawCircle(lineLeft + r + offset, r + offset, r, rectPaint);
        } else {
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            View currentView = tabsContainer.getChildAt(position);
            ...
            scrollToChild(position, (int) (positionOffset * currentView.getWidth()));
    ...
    public boolean isDotIndicator() {
        return dotIndicator;
    }

    public void setDotIndicator(boolean dotIndicator) {
