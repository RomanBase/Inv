...
public class TaskTracker {
    ...
    static public TaskTracker fromJson(JSONObject jsonObject) throws JSONException {
        final String tag = jsonObject.getString(Constants.TAG);
        final long windowStartElapsedSecs = jsonObject.optLong(Constants.WINDOW_START_ELAPSED_SECS);
        final long windowStopElapsedSecs = jsonObject.optLong(Constants.WINDOW_STOP_ELAPSED_SECS);
        final long period = jsonObject.optLong(Constants.PERIOD);
        final long flex = jsonObject.optLong(Constants.FLEX);
        final long createdAtElapsedSecs = jsonObject.optLong(Constants.CREATED_AT_ELAPSED_SECS);
        boolean cancelled = jsonObject.optBoolean(Constants.CANCELLED);
        boolean executed = jsonObject.optBoolean(Constants.EXECUTED);
    ...
    public JSONObject toJson() throws JSONException {
        ...
        jsonObject.put(Constants.TAG, tag);
        jsonObject.put(Constants.WINDOW_START_ELAPSED_SECS, windowStartElapsedSecs);
        jsonObject.put(Constants.WINDOW_STOP_ELAPSED_SECS, windowStopElapsedSecs);
        jsonObject.put(Constants.PERIOD, period);
        jsonObject.put(Constants.FLEX, flex);
        jsonObject.put(Constants.CREATED_AT_ELAPSED_SECS, createdAtElapsedSecs);
        jsonObject.put(Constants.CANCELLED, cancelled);
        jsonObject.put(Constants.EXECUTED, executed);
        return jsonObject;
    }
