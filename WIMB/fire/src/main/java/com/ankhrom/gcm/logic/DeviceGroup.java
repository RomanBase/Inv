...
public class DeviceGroup {
    ...
    static public DeviceGroup fromJson(JSONObject json) throws JSONException {
        ...
        deviceGroup.notificationKeyName = json.getString(Constants.NOTIFICATION_KEY_NAME);
        deviceGroup.notificationKey = json.optString(Constants.NOTIFICATION_KEY);

        // read "tokens": {"token1" : "1234", "token2" : "3434"}
        JSONObject jsonTokens = json.optJSONObject(Constants.TOKENS);
        if (jsonTokens != null) {
    ...
    public JSONObject toJson() throws JSONException {
        ...
        json.put(Constants.NOTIFICATION_KEY_NAME, notificationKeyName);
        json.put(Constants.NOTIFICATION_KEY, notificationKey);
        json.put(Constants.TOKENS, new JSONObject(tokens));
        return json;
    }
}
